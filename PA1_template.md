...
![](PA1_template_files/figure-markdown_strict/unnamed-chunk-4-2.png) we
can see from above charts that the mode of the average number of steps
per day is between 35 and 40 when the median is at 0
